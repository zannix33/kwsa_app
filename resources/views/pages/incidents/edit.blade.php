...
@push('custom-scripts')
    ...
    <script>
        ...
        function loadIncidentTypes(selected = null)
        {
            ...
            dropdown.append('<option value="">Select Incident Type</option>');
            ...
            $.each(list,function(index,item){
                ...
                dropdown.append(
                    '<option value="'+item+'" '+selectedText+'>'+item+'</option>'
                );
        ...
        $(document).ready(function(){
            ...
            loadIncidentTypes(
                "{{ old('incident_type',$incident->incident_type) }}"
            );
